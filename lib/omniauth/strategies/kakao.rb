...
module OmniAuth
  module Strategies
    class Kakao < OmniAuth::Strategies::OAuth2
      ...
      option :client_options, { site: 'https://kauth.kakao.com', authorize_path: '/oauth/authorize', token_url: '/oauth/token' }

      uid { raw_info['id'].to_s }

      info { { 'name' => raw_properties['nickname'], 'image' => raw_properties['thumbnail_image'] }.merge(kakao_account) }

      extra { { 'properties' => raw_properties } }
